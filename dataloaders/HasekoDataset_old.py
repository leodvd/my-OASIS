...
class HasekoDataset(torch.utils.data.Dataset):   # dataloader for dataset9 / dataset10 / bim (different bedroom colors and sanitaries)
...
#
#         # the channel/layer 0 is already full of 255 values and the 128 values of the footprint because of the label copy and threshold
#
