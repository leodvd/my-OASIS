...
def add_all_arguments(parser, train):
    #--- general options ---
    parser.add_argument('--name', type=str, default='label2haseko_noaug_aug', help='name of the experiment. It decides where to store samples and models')
    ...
    parser.add_argument('--dataroot', type=str, default='../datasetv8/', help='path to dataset root')
    parser.add_argument('--dataset_mode', type=str, default='haseko', help='this option indicates which dataset should be loaded')
    parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for data argumentation')
    parser.add_argument('--im_size', type=int, default=256, help='the load and crop size of the image')
    ...
    if train:
        ...
        parser.add_argument('--freq_save_latest', type=int, default=5000, help='frequency of saving the latest model')
        ...
        parser.add_argument('--freq_fid', type=int, default=50000000, help='frequency of saving the fid score (in training iterations)')
        ...
        parser.add_argument('--channels_D', type=int, default=32, help='# of discrim filters in first conv layer in discriminator')
